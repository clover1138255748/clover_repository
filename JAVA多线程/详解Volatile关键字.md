...
- [可见性的解决方案](#--------)
  * [**加锁**](#------)
  * [**为啥加锁可以解决可见性问题呢？**](#-------------------)
  * [**Volatile修饰共享变量**](#--volatile--------)
  * [**Volatile做了啥？**](#--volatile------)
- [MESI（缓存一致性协议）](#mesi---------)
  * [**至于是怎么发现数据是否失效呢？**](#-------------------)
- [嗅探](#--)
  * [嗅探的缺点](#-----)
- [happens-before原则](#happens-before--)
- [无法保证原子性](#-------)
  * [**大家可能好奇为啥要双重检查？如果不用Volatile会怎么样？**](#--------------------volatile-------)
  * [**可见性怎么保证的？**](#-------------)
- [volatile与synchronized的区别](#volatile-synchronized---)
- [总结](#--)
